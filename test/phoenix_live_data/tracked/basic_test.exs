defmodule LiveData.Tracked.BasicTest do
  ...
  test "fully static data structure" do
    ...
    out =
      %LiveData.Tracked.RenderTree.Static{} = module.__tracked__fully_static_data_structure__()
  ...
  test "with atom case" do
    ...
    out =
      %LiveData.Tracked.RenderTree.Static{} = module.__tracked__with_atom_case__(%{:foo => :bar})

    assert out.slots == []
    assert out.template == {:literal, 1}

    out =
      %LiveData.Tracked.RenderTree.Static{} = module.__tracked__with_atom_case__(%{:foo => :baz})
  ...
  test "key in non return position" do
    {:error, _module, _trace, error, _stacktrace} =
  ...
  # true = module.__tracked__testing__([a: 1])
  #end
end
